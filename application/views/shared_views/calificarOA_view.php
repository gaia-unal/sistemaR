...
<div class="col-lg-9">
    ...
    <section class="panel">
        <header class="panel-heading">
            Califique 10 recursos educativos
            <div id="prueba"></div>
        </header>
        <div class="panel-body">
            ...
            if (!empty($result[0])) {
                foreach ($result as $key) {
                    ...
                    $rep_id= base64_encode($key['rep_id']);
                    $lo_id= base64_encode($key['lo_id']);

                    ?>
                    <div class="classic-search">

                        <p><a target="_blank" class="titulo" id="<?php echo $key['lo_id'] ?>" rep_id="<?php echo $key['rep_id'] ?>" logged="<?php echo $logged ?>" href="<?php echo base_url().'lo/load_lo/'.$url.'/'.$lo_name.'/'.$lo_id.'/'.$rep_id ?>"><?php echo $key['lo_title'] ?></a>
                        </p>
                        <div>
