   <?php foreach ($usr_data as $usr){} ?>
    <!--header start-->
      <div id="unalTop" >
        ...
        <div class="seal">
            <img alt="Escudo de  Colombia" src="<?php echo base_url()?>asset/img/sealColombia.png" width="66" height="66" />
        </div>
        <div class="firstMenu">
    ...
    <br>
      ...
      <header class="header white-bg" >
            ...
            <!--logo start-->
            <a href="<?php echo base_url()?>" class="logo tooltips"  data-placement="right" ><span>SistemaR</span></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar1" src="./img/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar2" src="<?php echo base_url()?>/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar3" src="<?php echo base_url()?>/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
